...
echo "                              NOTICE                                "
echo ""
echo "iemocap_prep_data.sh: Generate text, textraw, utt2spk, spk2utt, and wav.scp."
...
# segments
# In iemocap Readspeech corpus, each audio file contains only one sentence. Therefore, segement information is not needed. 
